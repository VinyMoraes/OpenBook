...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <h1>Login</h1>
            <form action="config/verificaLogin.php" method="post" class="form-responsivo">
                ...
                <div class="icon-input">
                    ...
                    <input class="input-forms" type="password" name="senha" id="senha" placeholder="senha123" required
