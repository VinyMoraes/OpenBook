            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        $sql_registros = "SELECT * FROM livros ORDER BY id ASC";
                        ...
                        if ($resultado && $resultado->num_rows > 0) {
                            while ($user_data = $resultado->fetch_assoc()) {
                                ...
                                echo "<td> 
                                <a class='btn btn-sm btn-primary' href='editarLivro.php?id=" . $user_data['id'] . "'>
                                    <i class='fa fa-edit'></i>
                                </a>
                                <a class='btn btn-sm btn-danger' href='../config/deleteLivro.php?id=" . $user_data['id'] . "'>
