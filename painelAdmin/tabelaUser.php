                    ...
                    <tbody>
                        ...
                        if ($resultado && $resultado->num_rows > 0) {
                            while ($user_data = $resultado->fetch_assoc()) {
                                ...
                                echo "<td>" . ($user_data['permissao'] == 1 ? 'Admin' : 'Usuário') . "</td>";
                                echo "<td> 
                                <a class='btn btn-sm btn-primary' href='editarUser.php?id=" . $user_data['id'] . "'>
                                    <i class='fa fa-edit'></i>
                                </a>
                                <a class='btn btn-sm btn-danger' href='../config/deleteUser.php?id=" . $user_data['id'] . "'>
