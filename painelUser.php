...
if (!isset($_SESSION['email']) || !isset($_SESSION['permissao']) || $_SESSION['permissao'] != 0) {
    // Se não estiver logado ou não for usuário comum, redireciona para a página de login
...
<body>
    ...
    <main class="container">
        <div class="title-painel text-center">
            <h2>Seja Bem Vindo(a) ao Painel de Usuário</h2>
        </div>
        <div class="row justify-content-center painel-funcoes">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3 funcoes">
                <a href="painelUser/alugarLivro.php">
                    <i class="fa fa-book"></i> Alugar Livro
                </a>
            </div>

            <div class="col-12 col-sm-6 col-md-4 col-lg-3 funcoes">
                <a href="painelUser/listarAluguel.php">
                    <i class="fa fa-random"></i> Listar Aluguel do Livro
                </a>
            </div>
